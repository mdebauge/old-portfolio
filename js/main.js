...
$(window).load(function() {
    ...
    $('.about').hide(0).delay(800).fadeIn(2500);
});
...
$('.site-header').hover(
  function() {
    ...
    $('.nav-trigger').addClass('show-nav');
    $('.navbar-brand').addClass('show-nav');
    $('#about-about').addClass('show-nav');
  }, function() {

    $('.nav-trigger').removeClass('show-nav');
    $('.navbar-brand').removeClass('show-nav');
    $('#about-about').removeClass('show-nav');
  }
);
